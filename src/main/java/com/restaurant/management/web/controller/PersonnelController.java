...
public class PersonnelController {
    ...
    Resource<PersonnelFormDTO> updatePerson(@CurrentUser UserPrincipal currentUser,
        ...
        PersonnelFormDTO personnelDTO = personnelFacade.updatePerson(currentUser, request);
    ...
    public @ResponseBody
    ResponseEntity<PagedResources<PersonnelFormDTO>> getAllPersonnel(@CurrentUser UserPrincipal currentUser,
                                                                         Pageable pageable,
